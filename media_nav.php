        ...
        <div class="btn-groupx" role="group">
           <div class="btn-group" role="group">
            ...
            <div class="btn-group" role="group" data-type="media">
             ...
             <!-- <div class="btn-group" role="group">
          <div id="btnGroupVerticalDrop3" type="button" class="btn btn-default dropdown" data-toggle="unactive">
              AS SEEN ON TV
          </div>
          <ul class="dropdown-menu" id='channels_sub' role="menu" aria-labelledby="btnGroupVerticalDrop3">
          </ul>
      </div>  -->
        </div>
     </div>