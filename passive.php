...
<head>
  ...
  <link rel="stylesheet" href="<? echo THIS_SITE; ?>stylesheets/passive.min.css?nocache=0127">
...
<meta property="og:description" content="<? echo str_replace('"','',strip_tags($meta_desc)); ?>"/>
...
<meta name="twitter:description" content="<? echo str_replace('"','',strip_tags($meta_desc)); ?>">
...
<style>
.styleSelect{  background: #e2e0e1 url("<?echo THIS_SITE;?>img/select_ico.jpg") no-repeat 100% 50%;}
...
<body>
  ...
  <div id="vdo_wapper" style="display:table;position:relative;top:130px;padding-bottom:100px;">
			...
			<div id="ad_box728x90" ><?echo $ad728x90;?></div> 
      <!-- heaeder  -->
      <div class="passive_header">  
         ...
         <div class="styleSelect btn">
             <label class="current_list"><?echo $current_title;?></label>
          </div>
     ...
     <!-- video player -->
		...
		<div id="vodx_playnext" class="vodxcls"><img src="<?echo THIS_SITE;?>img/right_ico2.png"></div>
        <div id="vodx_playprev" class="vodxcls"><img src="<?echo THIS_SITE;?>img/left_ico2.png"></div>
     ...
     <div class='thumbnails_container current'>
       ...
       <div class="thumbnails_container_box_line">
         ...
         <div class="btn_left btn"><img src="<?echo THIS_SITE;?>img/left_ico.png"></div>
         <div class="btn_right btn"><img src="<?echo THIS_SITE;?>img/right_ico.png"></div>

     </div>
     <!-- player info -->
     <div class="vdo_infobox">
         <div class="vdo_infobox_left"><div id="ad_box300x250"><?echo $ad_psv_300x250;?></div></div>
         <div class="vdo_infobox_right">
           ...
           <div class="social_top" style="display:table-cell" id="scbar_top">			
						  <div class="sc_item fb "><img img width="100%" class='rwd_image' src="<?echo THIS_SITE;?>img/icon_fb_s.png"></div>
						  <div class="sc_item twr "><img img width="100%" class='rwd_image' src="<?echo THIS_SITE;?>img/icon_tw_s.png"></div>
						  <a href="whatsapp://send?text=<?echo THIS_SITE. $video_id?> via @TomoNewsUS" data-action="share/whatsapp/share"> <div class="sc_item wapp " ><img img width="100%"  class='rwd_image' src="<?echo THIS_SITE;?>img/icon_wapp_s.png"></div></a>
						  <div class="sc_item email "><img img width="100%"  class='rwd_image' src="<?echo THIS_SITE;?>img/icon_email_s.png"></div>
						  <div class="sc_item btn_social" ><img img width="100%" class='rwd_image' src="<?echo THIS_SITE;?>img/icon_plus_s.png"></div>
						  <div class="sc_item url sc_item2 invi "><img img width="100%" class='rwd_image' src="<?echo THIS_SITE;?>img/icon_url_s.png"></div>
						  <div class="sc_item gplus sc_item2 invi"><img img width="100%" class='rwd_image' src="<?echo THIS_SITE;?>img/icon_gplus_s.png"></div>
						  <div class="sc_item stum sc_item2 invi"><img img width="100%" class='rwd_image' src="<?echo THIS_SITE;?>img/icon_stumble_s.png"></div>
						  <div class="sc_item reddit sc_item2 invi"><img img width="100%" class='rwd_image' src="<?echo THIS_SITE;?>img/icon_reddit_s.png"></div>
					</div>
					<div style="display:table-cell;vertical-align:middle;width:150px;" align="right">
						<span>&nbsp;&nbsp;&nbsp;</span>
						<span style="font-size:12pt"></span>
							<!--<img src="img/icon_eye.gif">
							<span style="font-size:9.5pt"><? //echo number_format($counter) ?></span>-->
					</div>
     ...
     <div class="thumbnails_container bottom b1">
       <a class="list_tit"href="<?echo THIS_SITE.$playlistsBottom_arr[0];?>"> <div class="thumbnails_container_title"><?echo $plTitles_arr[1];?></div></a>
         <div class='thumbnails_container_box'>
         <div class="bottom_loading"><img src="<?echo THIS_SITE;?>img/loading11.gif"></div>
         <div class="thumbnails_container_box_line">
        <div class="thumbnail_item">
     ...
     <div class="thumbnails_container bottom b2">
        <a class="list_tit"href="<?echo THIS_SITE.$playlistsBottom_arr[1];?>"><div class="thumbnails_container_title"><?echo $plTitles_arr[2];?></div></a>
        <div class='thumbnails_container_box'>
         <div class="bottom_loading"><img src="<?echo THIS_SITE;?>img/loading11.gif"></div>
         <div class="thumbnails_container_box_line">
        <div class="thumbnail_item">
     ...
     <div class="thumbnails_container bottom b3">
        <a class="list_tit"href="<?echo THIS_SITE.$playlistsBottom_arr[2];?>"><div class="thumbnails_container_title"><?echo $plTitles_arr[3];?></div></a>
        <div class='thumbnails_container_box'>
          <div class="bottom_loading"><img src="<?echo THIS_SITE;?>img/loading11.gif"></div>
         <div class="thumbnails_container_box_line">
        <div class="thumbnail_item">
     ...
     <div class="thumbnails_container bottom b4">
        <a class="list_tit"href="<?echo THIS_SITE.$playlistsBottom_arr[3];?>"><div class="thumbnails_container_title"><?echo $plTitles_arr[4];?></div></a>
        <div class='thumbnails_container_box'>
          <div class="bottom_loading"><img src="<?echo THIS_SITE;?>img/loading11.gif"></div>
         <div class="thumbnails_container_box_line">
        <div class="thumbnail_item">
      ...
      <div class="thumbnails_container bottom b5">
        <a class="list_tit"href="<?echo THIS_SITE.$playlistsBottom_arr[4];?>"><div class="thumbnails_container_title"><?echo $plTitles_arr[5];?></div></a>
        <div class='thumbnails_container_box'>
          <div class="bottom_loading"><img src="<?echo THIS_SITE;?>img/loading11.gif"></div>
         <div class="thumbnails_container_box_line">
        <div class="thumbnail_item">
     ...
     <div class="thumbnails_container bottom b6">
       <a class="list_tit"href="<?echo THIS_SITE.$playlistsBottom_arr[5];?>"> <div class="thumbnails_container_title"><?echo $plTitles_arr[6];?></div></a>
        <div class='thumbnails_container_box'>
  ...
  <script src="<? echo THIS_SITE; ?>js/passive.min.js?nocache=0127"></script>   
...
$(function() {
     ...
     _tbns_pl.init( _GLOBAL.list_id , <?echo $page;?> ,'<?echo $video_id; ?>' ,'.thumbnails_container.current .thumbnails_container_box_line' , _callback);

     function _callback(){
         var _tbns_pl1=new TBNS_PL_BOTTOM();
         _tbns_pl1.init('<?echo $playlists_arr[1];?>', 1 ,'' ,'.thumbnails_container.bottom.b1 .thumbnails_container_box_line','.thumbnails_container.bottom.b1');
         var _tbns_pl2=new TBNS_PL_BOTTOM();
         _tbns_pl2.init('<?echo $playlists_arr[2];?>', 1 ,'' ,'.thumbnails_container.bottom.b2 .thumbnails_container_box_line' ,'.thumbnails_container.bottom.b2');
         var _tbns_pl3=new TBNS_PL_BOTTOM();
         _tbns_pl3.init('<?echo $playlists_arr[3];?>', 1 ,'' ,'.thumbnails_container.bottom.b3 .thumbnails_container_box_line' ,'.thumbnails_container.bottom.b3');
         var _tbns_pl4=new TBNS_PL_BOTTOM();
         _tbns_pl4.init('<?echo $playlists_arr[4];?>', 1 ,'' ,'.thumbnails_container.bottom.b4 .thumbnails_container_box_line','.thumbnails_container.bottom.b4');
         var _tbns_pl5=new TBNS_PL_BOTTOM();
         _tbns_pl5.init('<?echo $playlists_arr[5];?>', 1 ,'' ,'.thumbnails_container.bottom.b5 .thumbnails_container_box_line' ,'.thumbnails_container.bottom.b5');
         var _tbns_pl6=new TBNS_PL_BOTTOM();
         _tbns_pl6.init('<?echo $playlists_arr[6];?>', 1 ,'' ,'.thumbnails_container.bottom.b6 .thumbnails_container_box_line','.thumbnails_container.bottom.b6');
	 }
