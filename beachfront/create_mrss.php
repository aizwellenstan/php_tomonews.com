...
define('SESSION_LIFETIME',2400);   
	...
	$getUrls2Now= APPLICATION_FEED_URL.'ABIAXWJMPBVAMS3RLMBA?start=0&count=150&filters[]=c_ts_publish_l:['.$sdate30.'%20TO%20'.$edate30.']&sort=c_ts_publish_l+desc'; 
...
function generate_new_xml($dAryn2, $save_path, $fileName){
	$xml_doc = new DOMDocument();
		...
		$titleCont = $xml_doc->createTextNode('RSS Feed for Beachfront');
