...
#header.fix-search #logo img{ content:url("<? echo THIS_SITE; ?>img/logo2.png"); width: 60px;padding: 1px 5px 3px 0px;}
	...
	<div class="top-menu-content" style="">
		...
		<div  style="" id="menus2" >
			...
			<div id="m23">
				...
				<p><a href="<? echo THIS_SITE; ?><? echo GIVEAWAY_LINK ?>" onclick="track_menu('GIVEAWAY' ,'<? echo THIS_SITE; ?><? echo GIVEAWAY_LINK ?>');return false;">Giveaway</a></p>
			</div>
			...
			<div id="m24">
				...
				<p><a href="<? echo JP_WEBSITE; ?>" target="_blank"><img src="<? echo THIS_SITE; ?>img/flag_jp.png"><span>English (US)</span></a></p>
			</div>
