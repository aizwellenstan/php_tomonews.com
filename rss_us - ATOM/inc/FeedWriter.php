...
abstract class FeedWriter
{
	...
	*/ 
	...
	{	
		...
		$this->channels['title']        = 'TomoNews | Animated News, Weird News and Funny Videos';
		$this->channels['link']         = $_SERVER['SERVER_NAME'];
				
		//Tag names to encode in CDATA
		$this->CDATAEncoding = array('description', 'content:encoded', 'summary', 'content' );
	}
	...
	*/
	...
	/**
	* Set the 'category' channel element
	* 
	* @access   public
	* @param    string  value of 'category' channel tag
	* @return   void
	*/
	public function setCategory($category)
	{
		$this->setChannelElement('category', $category);
	}	
	...
	*/
	private function makeNode($tagName, $tagContent, $attributes = null)
	{
		...
		{
			$nodeText .= (in_array($tagName, $this->CDATAEncoding))? $this->sanitizeCDATA($tagContent) : htmlspecialchars_decode($tagContent);
		}
