...
/// start 
	...
	$getUrls2Now= APPLICATION_FEED_URL.'KBJRKBD5PNUFPGRALF?filters[]=u_Video_Elephant_Feed_s:"'.$VESynd[0].'"&filters[]=c_ts_publish_l:['.$sdateNow.'%20TO%20'.$edateNow.']&media_filters[]=video/mp4&fmt=mrss'; 
...
if (!file_exists($save_path.$fileName)){
	...
	header('Location:  http://us.tomonews.com/mrss/mrss');
// 
}
