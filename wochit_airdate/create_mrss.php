...
/// start 
	...
	// BEGIN Syndicate Now
	$sdate30=strtotime('1 November 2016');
	$edate30=strtotime('31 December 2016');
	$getUrls2Now= APPLICATION_FEED_URL.'K5DFKW44EZ4AIUALAEDA?start=0&count=150&filters[]=c_ts_airdate_l:['.$sdate30.'%20TO%20'.$edate30.']&sort=c_ts_airdate_l+desc'; 
	print_r($getUrls2Now);
...
function generate_new_xml($dAryn2, $save_path, $fileName){
	$xml_doc = new DOMDocument();
		...
		$titleCont = $xml_doc->createTextNode('RSS Feed for Wochit');
