...
<body>
	...
	<div id="aboutc">
      ...
      <br>
		...
		<div id="aboutc3">
			<a class="links" href="<? echo APP_APPLE_STORE; ?>" target="_blank"><img src="img/hd_as.jpg" ></a>
			<a class="links" href="<? echo APP_GOOGLE_PLAY; ?>" target="_blank"><img src="img/hd_gp.jpg" ></a>
			
			<a class="icons" href="<? echo FB_LINKS ?>" target="_blank"><img src="img/icon_48_fb.gif"  ></a>
			<a class="icons" href="<? echo TWITTER_LINKS ?>" target="_blank"><img src="img/icon_48_tw.gif" ></a>
			<a class="icons" href="<? echo GPLUS_LINKS ?>" target="_blank"><img src="img/icon_48_gplus.gif"  ></a>
			<a class="icons" href="<? echo INSTAGRAM_LINKS ?>" target="_blank"><img src="img/icon_48_instagram.gif"></a>
			<br><br>
			<hr>
			<br>
