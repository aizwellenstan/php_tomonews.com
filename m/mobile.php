...
<head>
    ...
    <link rel="canonical" href="<? echo THIS_SITE_DESKTOP.'mobileApp'; ?>" />
  ...
  <div id="lists">
    ...
    <div style="position: absolute; top: 1205px; left: 327px; width: 410px; height: 40px; display:none"> 
		...
		<form action="//nma.us2.list-manage.com/subscribe/post?u=28c2f2044f22c46a64747226f&amp;id=c5744b2475" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
		    ...
		    <input type="image" class="pmc" src="<? echo THIS_SITE; ?>img/sign_up_now2.gif" border="0">
...
<form action="//tomonews.us2.list-manage.com/subscribe/post?u=28c2f2044f22c46a64747226f&amp;id=8254ba5d15" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
    ...
    <input type="image" class="pmc" src="<? echo THIS_SITE; ?>img/sign_up_now.gif" border="0">
...
<!--End mc_embed_signup-->
    ...
    <map name="Map">
      <area shape="rect" coords="663,653,872,730" href="<? echo APP_GOOGLE_PLAY; ?>" target="_blank">
      <area shape="rect" coords="663,874,869,945" href="<? echo APP_APPLE_STORE; ?>" target="_blank">
      
      <!--area shape="rect" coords="383,1229,615,1290" href="http://eepurl.com/YDM81" target="_blank"-->
      <area shape="rect" coords="400,1115,437,1154" href="<? echo FB_LINKS ?>" target="_blank">
      <area shape="rect" coords="440,1116,478,1154" href="<? echo TWITTER_LINKS ?>" target="_blank">
      <area shape="rect" coords="481,1116,519,1153" href="<? echo GPLUS_LINKS ?>" target="_blank">
      <area shape="rect" coords="523,1116,561,1154" href="<? echo YOUTUBE_LINKS ?>" target="_blank">
      <area shape="rect" coords="565,1116,601,1154" href="<? echo INSTAGRAM_LINKS ?>" target="_blank">
    </map>

    <map name="Map2">
      <area shape="rect" coords="220,70,470,150" href="<? echo APP_GOOGLE_PLAY; ?>" target="_blank">
      <area shape="rect" coords="220,290,470,357" href="<? echo APP_APPLE_STORE; ?>" target="_blank">
      
      <!--area shape="rect" coords="383,1229,615,1290" href="http://eepurl.com/YDM81" target="_blank"-->
      <area shape="rect" coords="62,496,111,544" href="<? echo FB_LINKS ?>" target="_blank">
      <area shape="rect" coords="156,496,205,544" href="<? echo TWITTER_LINKS ?>" target="_blank">
      <area shape="rect" coords="250,496,299,544" href="<? echo GPLUS_LINKS ?>" target="_blank">
      <area shape="rect" coords="344,496,393,544" href="<? echo YOUTUBE_LINKS ?>" target="_blank">
      <area shape="rect" coords="438,496,487,544" href="<? echo INSTAGRAM_LINKS ?>" target="_blank">
    </map>

    <map name="Map3">
      <area shape="rect" coords="120,40,250,80" href="<? echo APP_GOOGLE_PLAY; ?>" target="_blank">
      <area shape="rect" coords="120,153,250,190" href="<? echo APP_APPLE_STORE; ?>" target="_blank">
      
      <!--area shape="rect" coords="383,1229,615,1290" href="http://eepurl.com/YDM81" target="_blank"-->
      <area shape="rect" coords="33,263,60,290" href="<? echo FB_LINKS ?>" target="_blank">
      <area shape="rect" coords="81,263,108,290" href="<? echo TWITTER_LINKS ?>" target="_blank">
      <area shape="rect" coords="129,263,156,290" href="<? echo GPLUS_LINKS ?>" target="_blank">
      <area shape="rect" coords="177,263,204,290" href="<? echo YOUTUBE_LINKS ?>" target="_blank">
      <area shape="rect" coords="225,263,252,290" href="<? echo INSTAGRAM_LINKS ?>" target="_blank">
    </map>
