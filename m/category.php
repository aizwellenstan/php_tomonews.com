...
<link rel="stylesheet" type="text/css" href="https://cloud.typography.com/7365156/7009372/css/fonts.css" />
    ...
    <script src="<?echo THIS_SITE;?>js/all.min.js?nocache=1217"></script>
...
<body>
	...
	<div id="lists">
		<div id="cate_lab" class="w<? echo $cate_id; ?>" align="center" style="text-trans; top:0px;margin-bottom:10px;">
			<? echo strtoupper ($cate_name) ; ?>
	    </div>
		<?
...
/*waterfall cate*/
    $("img.lazy").lazyload({
     ...
     _GLOBAL.NSFW  = false;
     _GLOBAL.temp_str_kw="<?echo $cate_id;?>";
	_GLOBAL.thisSite = "<? echo THIS_SITE?>";
	_GLOBAL.feedId = "<? echo $feedId ?>";


 	var datawall = new cate_waterfall()
 	_GLOBAL.datawalls.push(datawall)
  datawall.init('<?echo $cate_id;?>' , '<?echo $cate_name;?>', '<?echo PAGE_LIMIT_CATEGORY;?>');
