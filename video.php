...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title><? site_title_name() ?> <? echo $title_cp; ?></title>
		...
		<meta property="og:url" content="<? echo THIS_SITE.urlencode(str_replace(' ', '-', remove_punc($title_cp))).'-'.$video_id; ?>"/>
		...
		<script src="<? echo THIS_SITE; ?>js/imagesloaded.pkgd.min.js"></script>
		<script src="<? echo THIS_SITE; ?>js/common.min.js"></script>
		<script src="<? echo THIS_SITE; ?>js/slide.min.js?nocache=1208"></script> 
		<script src="//code.jquery.com/ui/1.9.2/jquery-ui.js"></script>
		<script src="https://vjs.zencdn.net/ie8/1.1.2/videojs-ie8.min.js"></script>
		<link href="https://vjs.zencdn.net/7.8.3/video-js.css" rel="stylesheet" />
		<link rel="canonical" href="<? echo THIS_SITE.urlencode(str_replace(' ', '-', remove_punc($title_cp))).'-'.$video_id; ?>" />
...
.rwd_image {
    ...
    height: auto;
		...
		{ 
		  ...
		  "mainEntityOfPage": {
			"@type": "WebPage",
			"@id": "<? echo THIS_SITE.urlencode(str_replace(' ', '-', remove_punc($title_cp))).'-'.$video_id; ?>"
		  },
		  "description": "<?echo str_replace('"','',strip_tags($mobDes));?>", 
		  "url": "<? echo THIS_SITE.urlencode(str_replace(' ', '-', remove_punc($title_cp))).'-'.$video_id; ?>", 
		...
		<meta itemprop="headline" content="<? echo strip_tags($title); ?>" />
		<meta itemprop="description" content="<? echo str_replace('"','',strip_tags($mobDes)); ?>" />
		<meta itemprop="image"  content="<? echo $thumb ?>" />
		<meta itemprop="datePublished"  content="<? echo $cdate ; ?>" />
		<? include_once('ga.php'); ?>
	</head>
...
<body>
	...
	<div id="vdo_wapper">
		...
		<div id="vdo_content" style="position: relative;float: left; max-width: 970px;">
			<div id="vdo_cnt">
				<h1 id="vdo_title"><? echo $title_cp; ?></h1> 
				...
				<div style="display:table;">
					...
					<div style="display:table-cell;vertical-align:middle;width:150px;" align="right">
						<span>&nbsp;&nbsp;&nbsp;</span>
						<span style="font-size:12pt"><? echo $cdate ?></span>
				...
				<div id="vdo_inf">
					<br>
					<a href="<? echo THIS_SITE; ?>theme/nsfw" style="text-decoration: none;<? if(!$NSFW  || IFNSFW_TEST!=1 || $thmenName=='NSFW'){echo 'display:none;';}?>">
				...
				<div class= "formbox">
					<img src='<? echo THIS_SITE; ?>img/bg_vdo_signup.png'>
					<div class="mcp_form3">
				...
				<div class= "nxt_vdo">
				<!--  $next_id $next_title-->
					<div class= "nxt_vdo_item" data-link="<?echo $next_link;?>">
						<div ><img src="<? echo $next_thumb ?>" width="211"></div>
                        ...
                        <div class="txt" style="font-weight: 700;font-size:20px;"><?echo $next_title;?></div>
					</div>
				...
				<!--<div id="disqus">
					<h1 style="color:#333;display:inline;font-size:22px;font-weight: 900;"><? echo $comm_qa; ?></h1><h2 style="color:#999;display:inline;margin:0px 20px;"></h2>
				</div>-->
				<div class="fbc-title comm-title" style="height: auto;margin: 0;">Facebook Conversation</div>
				<div class="fb-comments" data-href="<?echo 'http://us.tomonews.com/'.$video_id;?>" data-width="663" data-numposts="5" data-colorscheme="light" style="padding: 0px "></div>
						...
						<div align="center">
							...
							<div id="mc_embed_signup">
								<form action="//tomonews.us2.list-manage.com/subscribe/post?u=28c2f2044f22c46a64747226f&amp;id=8254ba5d15" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
									...
									<input type="image" class="pmc" src="<? echo THIS_SITE; ?>img/sign_up_now.gif" border="0" style="margin-left:125px;">
			...
			<div id="vdo_otherlist" style="position: relative; float: right; max-width: 300px;">
				...
				<div class="mov" style="width: 300px; height: 600px;display:block;background:#ccc;margin:0;margin-top:25px;margin-bottom:25px;"><? echo $ad300x600;?></div>
				<? include_once ('vdo_side_thumbnailA.php'); 
				   ///////YOU MAY ALSO LIKE//////
...
<div class='slideme'> 
 ...
 ?>
    ...
    <div class="top_nav">
       <div class="count"></div>
       <div class="btn_close btn"><img  src="<? echo THIS_SITE; ?>img/close_btn.png" width='20' height='20'></div>
   </div>
   <div class="caption">
   ...
   <div class="bottom_nav">
      <div>
         <div class="arr_l btn"><img  src="<? echo THIS_SITE; ?>img/arrow_l.png"></div>
         <div class="arr_r btn"><img  src="<? echo THIS_SITE; ?>img/arrow_r.png"></div>
      </div>
   </div>
</div>
<div id="dialog" title="">
...
<script type='text/javascript'>
  ...
  _GLOBAL.tempstr       = "<? echo htmlspecialchars ($title);?>"; //htmlentities($str, ENT_QUOTES); /
  _GLOBAL.XLARGE_THUMB  = '';
  _GLOBAL.app_key ="";
  _GLOBAL.vdo_id = <? echo $video_id; ?>;
  _GLOBAL.nxt_lnk=<? echo json_encode($next_link); ?>;
  _GLOBAL.prv_lnk=<? echo json_encode($prev_link); ?>;
...
<script src="<? echo THIS_SITE; ?>js/ymalO.js" defer></script>
<script src="<? echo THIS_SITE; ?>js/video.js" defer></script>
<script>
 ...
 $(function(){
    ...
    /* var _gg =new GIGYA();
     ...
     try{
        ...
        var theme_tag ='<?echo isset($thmenName_title) ? $thmenName_title : '';?>';
   ...
   this.init = function (){
    var commentParams ={
      categoryID: 'TomoNews US',
        streamID: "http://tomonews.com/<?echo $video_id ; ?>",
        version: 2,
